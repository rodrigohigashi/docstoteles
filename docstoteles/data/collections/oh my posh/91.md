...
Display the currently active [Rust](https://rust-lang.org/)
 version.
...
*   toml
    ...
    {  "type": "rust",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#193549",  "background": "#99908a",  "template": "  {{ .Full }} "}

    type: ruststyle: powerlinepowerline_symbol: foreground: "#193549"background: "#99908a"template: "  {{ .Full }} "
...
)[​](https://ohmyposh.dev/docs/segments/languages/rust#template-info "Direct link to template-info")
