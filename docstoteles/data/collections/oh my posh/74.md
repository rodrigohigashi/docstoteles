...
Display the currently active [Elixir](https://elixir-lang.org/)
 version.
...
*   toml
    ...
    {  "type": "elixir",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#422251",  "template": "  {{ .Full }} "}

    type: elixirstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#422251"template: "  {{ .Full }} "

    type = "elixir"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#422251"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/elixir#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/elixir#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/elixir#options)
