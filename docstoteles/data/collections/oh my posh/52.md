...
Display the currently active [Svelte](https://svelte.dev/docs/svelte/overview)
 version.
...
*   toml
    ...
    {  "type": "svelte",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#000000",  "background": "#1976d2",  "template": "  {{ .Full }} "}

    type: sveltestyle: powerlinepowerline_symbol: foreground: "#000000"background: "#1976d2"template: "  {{ .Full }} "

    type = "svelte"style = "powerline"powerline_symbol = ""foreground = "#000000"background = "#1976d2"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/svelte#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/svelte#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/svelte#options)
