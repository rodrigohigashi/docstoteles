[Skip to main content](https://ohmyposh.dev/docs/segments/languages/vala#__docusaurus_skipToContent_fallback)
...
Display the currently active [Vala](https://vala.dev/)
 version.
...
*   toml
    ...
    {  "type": "vala",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#5E20A4",  "template": "  {{ .Full }} "}

    type: valastyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#5E20A4"template: "  {{ .Full }} "

    type = "vala"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#5E20A4"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/vala#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/vala#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/vala#options)
