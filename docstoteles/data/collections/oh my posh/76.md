[Skip to main content](https://ohmyposh.dev/docs/segments/languages/fortran#__docusaurus_skipToContent_fallback)
...
Display the currently active [fortran](https://fortran-lang.org/)
 compiler version.

Compiler support

This only works with the [gfortran](https://fortranwiki.org/fortran/show/GFortran)
 compiler.
...
*   toml
    ...
    {  "type": "fortran",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#422251",  "template": " 󱈚 {{ .Full }} "}

    type: fortranstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#422251"template: " 󱈚 {{ .Full }} "

    type = "fortran"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#422251"template = " 󱈚 {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/fortran#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/fortran#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/fortran#options)
