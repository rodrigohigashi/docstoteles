...
Display the currently active [Julia](https://julialang.org/)
 version.
...
*   toml
    ...
    {  "type": "julia",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#4063D8",  "template": "  {{ .Full }} "}

    type: juliastyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#4063D8"template: "  {{ .Full }} "

    type = "julia"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#4063D8"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/julia#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/julia#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/julia#options)
