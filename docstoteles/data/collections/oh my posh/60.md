...
Display the currently active [yarn](https://yarnpkg.com/)
 version.
...
*   toml
    ...
    {  "type": "yarn",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#FFFFFF",  "background": "#2E2A65",  "template": "  {{ .Full }} "}

    type: yarnstyle: powerlinepowerline_symbol: foreground: "#FFFFFF"background: "#2E2A65"template: "  {{ .Full }} "

    type = "yarn"style = "powerline"powerline_symbol = ""foreground = "#FFFFFF"background = "#2E2A65"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/yarn#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/yarn#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/yarn#options)
