...
Display the currently active [Kotlin](https://kotlinlang.org/)
 version.
...
*   toml
    ...
    {  "type": "kotlin",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#906cff",  "template": "  {{ .Full }} "}

    type: kotlinstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#906cff"template: "  {{ .Full }} "

    type = "kotlin"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#906cff"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/kotlin#options "Direct link to Options")

-------------------------------------------------------------------------------------------------

Options[​](https://ohmyposh.dev/docs/segments/languages/kotlin#options-1 "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/kotlin#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/kotlin#options)
    
*   [Options](https://ohmyposh.dev/docs/segments/languages/kotlin#options-1)
