[Skip to main content](https://ohmyposh.dev/docs/segments/languages/golang#__docusaurus_skipToContent_fallback)
...
Display the currently active [Golang](https://go.dev/)
 version.
...
*   toml
    ...
    {  "type": "go",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#7FD5EA",  "template": "  {{ .Full }} "}

    type: gostyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#7FD5EA"template: "  {{ .Full }} "

    type = "go"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#7FD5EA"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/golang#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/golang#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/golang#options)
