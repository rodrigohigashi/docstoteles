...
Display the currently active [PHP](https://www.php.net/)
 version.
...
*   toml
    ...
    {  "type": "php",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#4063D8",  "template": "  {{ .Full }} "}

    type: phpstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#4063D8"template: "  {{ .Full }} "
...
)[​](https://ohmyposh.dev/docs/segments/languages/php#template-info "Direct link to template-info")
