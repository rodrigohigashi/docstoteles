...
Display the currently active [Buf CLI](https://buf.build/)
 version.
...
*   toml
    ...
    {  "type": "buf",  "style": "plain",  "foreground": "#1000D6",  "template": " 🐃 {{ .Full }} "}

    type: bufstyle: plainforeground: "#1000D6"template: " 🐃 {{ .Full }} "
...
)[​](https://ohmyposh.dev/docs/segments/cli/buf#template-info "Direct link to template-info")
