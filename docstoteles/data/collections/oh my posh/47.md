...
Display the currently active [npm](https://docs.npmjs.com/about-npm)
 version.
...
*   toml
    ...
    {  "type": "npm",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#193549",  "background": "#ffeb3b",  "template": " {{ .Full }} "}

    type: npmstyle: powerlinepowerline_symbol: foreground: "#193549"background: "#ffeb3b"template: " {{ .Full }} "

    type = "npm"style = "powerline"powerline_symbol = ""foreground = "#193549"background = "#ffeb3b"template = " {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/npm#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/npm#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/npm#options)
