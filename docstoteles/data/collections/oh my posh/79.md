...
Display the currently active [Java](https://www.java.com/)
 version.
...
*   toml
    ...
    {  "type": "java",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#4063D8",  "template": "  {{ .Full }}"}

    type: javastyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#4063D8"template: "  {{ .Full }}"

    type = "java"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#4063D8"template = "  {{ .Full }}"

Options[​](https://ohmyposh.dev/docs/segments/languages/java#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/java#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/java#options)
