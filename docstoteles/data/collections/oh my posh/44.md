...
Display the currently active [Maven](https://maven.apache.org/)
 version.
...
*   toml
    ...
    {  "type": "mvn",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#FFFFFF",  "background": "#2E2A65",  "template": "  {{ .Full }} "}

    type: mvnstyle: powerlinepowerline_symbol: foreground: "#FFFFFF"background: "#2E2A65"template: "  {{ .Full }} "

    type = "mvn"style = "powerline"powerline_symbol = ""foreground = "#FFFFFF"background = "#2E2A65"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/mvn#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/mvn#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/mvn#options)
