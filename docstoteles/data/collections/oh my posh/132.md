...
Display the currently active [Azure Functions CLI](https://github.com/Azure/azure-functions-core-tools)
 version.
...
*   toml
    ...
    {  "type": "azfunc",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#ffffff",  "background": "#FEAC19",  "template": "  {{ .Full }} ",  "options": {    "fetch_version": true,    "display_mode": "files"  }}

    type: azfuncstyle: powerlinepowerline_symbol: foreground: "#ffffff"background: "#FEAC19"template: "  {{ .Full }} "options:  fetch_version: true  display_mode: files

    type = "azfunc"style = "powerline"powerline_symbol = ""foreground = "#ffffff"background = "#FEAC19"template = "  {{ .Full }} "[options]fetch_version = truedisplay_mode = "files"

Options[​](https://ohmyposh.dev/docs/segments/cloud/azfunc#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cloud/azfunc#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cloud/azfunc#options)
