[Skip to main content](https://ohmyposh.dev/docs/segments/languages/r#__docusaurus_skipToContent_fallback)
...
Display the currently active [R](https://www.r-project.org/)
 version.
...
*   toml
    ...
    {  "type": "r",  "style": "powerline",  "powerline_symbol": "",  "foreground": "blue",  "background": "lightWhite",  "template": "  {{ .Full }} "}

    type: rstyle: powerlinepowerline_symbol: foreground: bluebackground: lightWhitetemplate: "  {{ .Full }} "

    type = "r"style = "powerline"powerline_symbol = ""foreground = "blue"background = "lightWhite"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/r#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/r#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/r#options)
