...
Display the currently active [Lua](https://www.lua.org/)
 or [LuaJIT](https://luajit.org/)
 version.
...
*   toml
    ...
    {  "type": "lua",  "style": "powerline",  "powerline_symbol": "",  "foreground": "white",  "background": "blue",  "template": "  {{ .Full }} "}

    type: luastyle: powerlinepowerline_symbol: foreground: whitebackground: bluetemplate: "  {{ .Full }} "

    type = "lua"style = "powerline"powerline_symbol = ""foreground = "white"background = "blue"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/languages/lua#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/languages/lua#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/languages/lua#options)
