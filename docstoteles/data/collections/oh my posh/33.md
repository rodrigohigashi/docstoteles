...
Display the currently active [Cmake](https://github.com/Kitware/CMake)
 version.
...
*   toml
    ...
    {  "type": "cmake",  "style": "powerline",  "powerline_symbol": "",  "foreground": "#E8EAEE",  "background": "#1E9748",  "template": "  cmake {{ .Full }} "}

    type: cmakestyle: powerlinepowerline_symbol: foreground: "#E8EAEE"background: "#1E9748"template: "  cmake {{ .Full }} "

    type = "cmake"style = "powerline"powerline_symbol = ""foreground = "#E8EAEE"background = "#1E9748"template = "  cmake {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/cmake#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/cmake#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/cmake#options)
