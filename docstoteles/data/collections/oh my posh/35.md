[Skip to main content](https://ohmyposh.dev/docs/segments/cli/deno#__docusaurus_skipToContent_fallback)
...
Display the currently active [Deno CLI](https://deno.land/)
 version.
...
*   toml
    ...
    {  "type": "deno",  "style": "plain",  "foreground": "#3C82F6",  "template": "  {{ .Full }} "}

    type: denostyle: plainforeground: "#3C82F6"template: "  {{ .Full }} "

    type = "deno"style = "plain"foreground = "#3C82F6"template = "  {{ .Full }} "

Options[​](https://ohmyposh.dev/docs/segments/cli/deno#options "Direct link to Options")
...
)[​](https://ohmyposh.dev/docs/segments/cli/deno#template-info "Direct link to template-info")
...
*   [Options](https://ohmyposh.dev/docs/segments/cli/deno#options)
